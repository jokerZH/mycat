...
public class MycatServer {
	...
	private final AtomicBoolean isOnline;	/* 是否运行 */
	private final long startupTime;				/* 启动时间 */
	private NamebleScheduledExecutor timerExecutor;	/* 时间事件线程池子 */
	private ListeningExecutorService listeningExecutorService;	/* 监听的线程池 TODO */
